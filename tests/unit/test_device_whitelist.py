...
@pytest.mark.parametrize(
    ("whitelist_definition", "tests"),
    [
        ([], [("foo.com", True), ("bar", True), ("10.0.0.1", True), ("172.24.1.1", True)]),
        (None, [("foo.com", True), ("bar", True), ("10.0.0.1", True), ("172.24.1.1", True)]),
        (
            ["*.com"],
            [("foo.com", True), ("a.foo.com", True), ("bar", False), ("10.0.0.1", False), ("172.24.1.1", False)],
        ),
        (
            ["*.foo.com", "bar"],
            [("foo.com", False), ("a.foo.com", True), ("bar", True), ("10.0.0.1", False), ("172.24.1.1", False)],
        ),
        (
            ["10.0.0.0/24"],
            [("foo.com", False), ("a.foo.com", False), ("bar", False), ("10.0.0.1", True), ("172.24.1.1", False)],
        ),
    ],
)
