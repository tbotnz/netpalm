...
async def match_textfsm_templates(template_match: TFSMTemplateMatch):
    attrs = {"Command": template_match.command, "Platform": template_match.driver}
...
async def return_specific_ttp_template(tmpname: str):
    try:
        send_payload = {"route_type": "ttp_templates", "name": tmpname}
        tmplate_mgr = unvrsl()
...
async def return_specific_config_j2_template(tmpname: str):
    try:
        send_payload = {"route_type": "j2_config_templates", "name": tmpname}
        tmplate_mgr = unvrsl()
        r = tmplate_mgr.get_template(payload=send_payload)
        resp = jsonable_encoder(r)
        return resp
...
async def return_specific_webhook_j2_template(tmpname: str):
    try:
        send_payload = {"route_type": "j2_webhook_templates", "name": tmpname}
        tmplate_mgr = unvrsl()
        r = tmplate_mgr.get_template(payload=send_payload)
        resp = jsonable_encoder(r)
        return resp
...
@router.post(
    "/j2template/render/webhook/{tmpname}",
...
async def return_specific_script_file(tmpname: str):
    try:
        send_payload = {"route_type": "custom_scripts", "name": tmpname}
        tmplate_mgr = unvrsl()
        r = tmplate_mgr.get_template(payload=send_payload)
        resp = jsonable_encoder(r)
        return resp
...
async def return_specific_webhook_script_file(tmpname: str):
    try:
        send_payload = {"route_type": "custom_webhooks", "name": tmpname}
        tmplate_mgr = unvrsl()
        r = tmplate_mgr.get_template(payload=send_payload)
        resp = jsonable_encoder(r)
        return resp
...
async def return_service_script_file(tmpname: str):
    try:
        send_payload = {"route_type": "python_service_templates", "name": tmpname}
        tmplate_mgr = unvrsl()
        r = tmplate_mgr.get_template(payload=send_payload)
        resp = jsonable_encoder(r)
        return resp
